...
{
    $stmt = $pdo->prepare('SELECT id, email, role, created_at, theme, password_hash FROM users WHERE id = ?');
    $stmt->execute([$userId]);
    ...
    <div>
        ...
        <form method="post" class="row g-3" novalidate>
            ...
            <div class="col-12 col-md-6">
                ...
                <select id="theme" name="theme" class="form-select<?= $themeError ? ' is-invalid' : '' ?>">
